    ...
    <>
      <NavigationContainer>
        <Stack.Navigator initialRouteName="Login Page">
          ...
          <Stack.Screen name="Register Page" component={Register} options={{headerShown:false}}/>
          <Stack.Screen
            name="Restaurants"
          ...
          <Stack.Screen
            ...
            options={{
              headerLeft: () =>(
                <IonIcon name="information-circle" size={30} style={styles.PageIcon}/>
              )
            }}
          />
          <Stack.Screen
          ...
          />
          <Stack.Screen name="Order CheckOut" component={OrderChecKOut} options={{
            headerLeft: () =>(
              <MaterialIcon name="cart-check" size={30} style={styles.PageIcon} />
            )
          }}/>
